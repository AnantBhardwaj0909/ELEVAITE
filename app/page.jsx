  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4 md:px-6">
        <h2 className="text-4xl font-extrabold tracking-tight text-center mb-16 text-gray-900 dark:text-white">Unleash the Power of Guru</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {features.map((feature, index) => (
            <Card
              ...
              "
            >
              <CardContent className="pt-6 pb-4 px-2 text-center flex flex-col items-center justify-start space-y-4">
